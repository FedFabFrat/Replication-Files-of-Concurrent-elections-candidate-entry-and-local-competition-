********************************************************************************
* Table A4
* Robustness: candidates entry with alternative control set
* Output: $output/tables/TableA4.tex
********************************************************************************
...
* n_cand *
qui reghdfe n_cand nlse_did $standard_controls if ever_natp_1 == 1 & ever_civp_1 == 1, a(codcom ele_date i.codreg#i.anno) vce(cl codcom)
...
local panel_A_prehead "\begin{table}[!h]\centering\begin{threeparttable}\scriptsize" ///
 "\caption{Concurrent national-local elections, candidates entry. Alternative set of controls}\label{tab:rob-alt-contr-n-cand}" ///
...
// first panel
esttab n_cand_1 n_cand_2 n_cand_3 n_natp_1 n_natp_2 n_natp_3 n_civp_1 n_civp_2 n_civp_3 using "$output/tables/TableA4.tex", ///
