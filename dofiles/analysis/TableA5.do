********************************************************************************
* Table A5
* Robustness: electoral outcomes with alternative control set
* Output: $output/tables/TableA5.tex
********************************************************************************
...
global standard_controls "popolazione_residente indice_vecchiaia incidenza_stranieri incidenza_adul_dip_lau tasso_occ_agric tasso_occ_industr tasso_occ_terz"
global standard_controls_base "popolazione_residente_91 indice_vecchiaia_91 incidenza_stranieri_91 incidenza_adul_dip_lau_91 tasso_occ_agric_91 tasso_occ_industr_91 tasso_occ_terz_91"

* ele_out *
qui reghdfe sh_votes_civp_1st nlse_did $standard_controls if ever_natp_1 == 1 & ever_civp_1 == 1, a(codcom ele_date i.codreg#i.anno) vce(cl codcom)
...
foreach y of varlist sh_votes_natp_1st sh_votes_civp_1st natwin civwin inv_hhi {
	...
	qui eststo `y'_2: reghdfe `y' nlse_did $standard_controls if ever_natp_1 == 1 & ever_civp_1 == 1 & esam == 1, a(codcom ele_date) vce(cl codcom)
	qui eststo `y'_3: reghdfe `y' nlse_did $standard_controls if ever_natp_1 == 1 & ever_civp_1 == 1 & esam == 1, a(codcom ele_date i.codreg#i.anno) vce(cl codcom)
...
local panel_A_prehead "\begin{table}[!h]\centering\begin{threeparttable}" ///
 "\caption{Concurrent national-local elections, electoral outcomes. Alternative set of controls}\label{tab:rob-alt-contr-ele-out}" ///
...
"Controls include: population, elderly index, foreigners index, tertiary-education index, and employment rate in agriculture, industry, and services. " + ///
...
// first panel
esttab sh_votes_natp_1st_1 sh_votes_natp_1st_2 sh_votes_natp_1st_3 sh_votes_civp_1st_1 sh_votes_civp_1st_2 sh_votes_civp_1st_3 using "$output/tables/TableA5.tex", ///
...
// second panel
esttab natwin_1 natwin_2 natwin_3 civwin_1 civwin_2 civwin_3 using "$output/tables/TableA5.tex", ///
...
// last panel
esttab inv_hhi_1 inv_hhi_2 inv_hhi_3 using "$output/tables/TableA5.tex", ///
tex compress nomtitles append nonumbers b (3) se starlevels(* 0.10 ** 0.05 *** 0.01) keep(nlse_did) coeflabels(nlse_did "\textit{NLCE\textsubscript{i,t}}") ///
