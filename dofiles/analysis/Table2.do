********************************************************************************
* Table 2
* Concurrent national-local elections and electoral outcomes
...
local panel_A_prehead "\begin{table}[!h]\centering\begin{threeparttable}" ///
 "\caption{Concurrent national-local elections, electoral outcomes.}\label{tab:ele-out}" ///
...
// first panel
esttab sh_votes_natp_1st_1 sh_votes_natp_1st_2 sh_votes_natp_1st_3 sh_votes_civp_1st_1 sh_votes_civp_1st_2 sh_votes_civp_1st_3 using "$output/tables/Table2.tex", ///
...
// second panel
esttab natwin_1 natwin_2 natwin_3 civwin_1 civwin_2 civwin_3 using "$output/tables/Table2.tex", ///
...
// last panel
esttab inv_hhi_1 inv_hhi_2 inv_hhi_3 using "$output/tables/Table2.tex", ///
tex compress nomtitles append nonumbers b (3) se starlevels(* 0.10 ** 0.05 *** 0.01) keep(nlse_did) coeflabels(nlse_did "\textit{NLCE\textsubscript{i,t}}") ///
