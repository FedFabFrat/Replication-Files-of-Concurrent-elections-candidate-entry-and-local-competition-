********************************************************************************
* Table 1
* Concurrent national-local elections and candidates entry
* Output: $output/tables/Table1.tex
********************************************************************************
...
local panel_A_prehead "\begin{table}[!h]\centering\begin{threeparttable}\scriptsize" ///
 "\caption{Concurrent national-local elections, candidates entry.}\label{tab:n-cand}" ///
...
// first panel
esttab n_cand_1 n_cand_2 n_cand_3 n_natp_1 n_natp_2 n_natp_3 n_civp_1 n_civp_2 n_civp_3 using "$output/tables/Table1.tex", ///
