********************************************************************************
* Table A10
* Robustness: candidates entry - restricted post-treatment period (t+2)
* Output: $output/tables/TableA10.tex
********************************************************************************
...
recode count_post .=0
qui reghdfe n_cand nlse_did $controls if ever_natp_1 == 1 & ever_civp_1 == 1 & count_post <= 2, a(codcom ele_date i.codreg#i.anno) vce(cl codcom)
cap drop esam
...
local panel_A_prehead "\begin{table}[!h]\centering\begin{threeparttable}\scriptsize" ///
 "\caption{Concurrent national-local elections, candidates entry. Restricting the post-treatment period.}\label{tab:n-cand-res-tpost}" ///
...
// first panel
esttab n_cand_1 n_cand_2 n_cand_3 n_natp_1 n_natp_2 n_natp_3 n_civp_1 n_civp_2 n_civp_3 using "$output/tables/TableA10.tex", ///
